...
<script type="text/javascript"
	src="${pageContext.request.contextPath }/resources/js/customer/department/list.js"></script>
<div class="page-header">

	<button id="btnEdit" type="button"
		onclick="webside.common.addModel('/department/addUI.html')"
		class="btn btn-success btn-sm">
		<i class="fa fa-pencil-square-o"></i>&nbsp;添加
	</button>

	<button id="btnEdit" type="button"
		onclick="webside.common.editModel('/department/editUI.html')"
		class="btn btn-success btn-sm">
		<i class="fa fa-pencil-square-o"></i>&nbsp;编辑
	</button>

	<button id="btnDel" type="button"
		onclick="webside.common.delModel('/department/delete.html', customSearch)"
...
<div class="input-group">
	<input id="searchKey" type="text" class="input form-control"
		placeholder="部门名称..."> <span class="input-group-btn">
