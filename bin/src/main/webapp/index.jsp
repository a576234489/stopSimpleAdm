	...
	<div id="navbar" class="navbar navbar-default">
		...
		<div class="navbar-container" id="navbar-container">
			...
			<div class="navbar-header pull-left">
				...
				<div class="navbar-brand animated bounceInRight"> 
					<small> 
						<img src="${ctx }/resources/images/logo_no_title.png" height="25px"/>fire管理系统
					</small>
				</div>
	...
	<div class="main-container" id="main-container">
		...
		<div class="main-content">
			<div class="main-content-inner">
				...
				<!-- /section:basics/content.breadcrumbs -->
				<div class="page-content animated slideInRight"></div>
				<!-- /.page-content -->
			</div>
		</div>
		<!-- /.main-content -->
		...
		<div class="footer">
			<div class="footer-inner">
				...
				<div class="footer-content">
					<span class="bigger-120"> <span class="blue bolder">fire</span>
