...
<script type="text/javascript"
	src="${pageContext.request.contextPath }/resources/js/customer/brigade/list.js"></script>
<div class="page-header">

	<button id="btnEdit" type="button"
		onclick="webside.common.addModel('/brigade/addUI.html')"
		class="btn btn-success btn-sm">
		<i class="fa fa-pencil-square-o"></i>&nbsp;添加
	</button>

	<button id="btnEdit" type="button"
		onclick="webside.common.editModel('/brigade/editUI.html')"
		class="btn btn-success btn-sm">
		<i class="fa fa-pencil-square-o"></i>&nbsp;编辑
	</button>

	<button id="btnDel" type="button"
		onclick="webside.common.delModel('/brigade/delete.html', customSearch)"
...
<div class="input-group">
	<input id="searchKey" type="text" class="input form-control"
		placeholder="消防队名称..."> <span class="input-group-btn">
	...
	<div class="col-xs-12 widget-container-col ui-sortable"
		...
		<div class="widget-box transparent ui-sortable-handle"
			...
			<div class="widget-header">
				<h4 class="widget-title lighter">消防队列表</h4>
