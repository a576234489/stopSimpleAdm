...
<script type="text/javascript"
	src="${pageContext.request.contextPath }/resources/js/customer/truckTypeThree/list.js"></script>
<div class="page-header">

	<button id="btnEdit" type="button"
		onclick="webside.common.addModel('/truckTypeThree/addUI.html')"
		class="btn btn-success btn-sm">
		<i class="fa fa-pencil-square-o"></i>&nbsp;添加
	</button>

	<button id="btnEdit" type="button"
		onclick="webside.common.editModel('/truckTypeThree/editUI.html')"
		class="btn btn-success btn-sm">
		<i class="fa fa-pencil-square-o"></i>&nbsp;编辑
	</button>

	<button id="btnDel" type="button"
		onclick="webside.common.delModel('/truckTypeThree/delete.html', customSearch)"
...
<div class="input-group">
	<input id="searchKey" type="text" class="input form-control"
		placeholder="消防车三级分类名称..."> <span class="input-group-btn">
	...
	<div class="col-xs-12 widget-container-col ui-sortable"
		...
		<div class="widget-box transparent ui-sortable-handle"
			...
			<div class="widget-header">
				<h4 class="widget-title lighter">消防车三级分类列表</h4>
