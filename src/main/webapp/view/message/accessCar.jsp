...
<body ng-app="stopSimple" ng-controller="roleController" ng-init="">
      ...
      <form class="layui-form">
		<table cellpadding="0" cellspacing="0" class="screenBox">
			<tbody>
				...
				<tr>
					<td class="w_1">出入类型</td>
					<td class="w_2">
						<ul class="info">
							<li> <input type="checkbox" name="" title="进场" lay-skin="primary" lay-filter="admission_"></li>
							<input type="hidden"  name="admission" class="admission_">
							
							<li> <input type="checkbox" name="" title="出场" lay-skin="primary" lay-filter="exit_"></li>
  ...
  }).use(['index', 'accessCar', 'table','laydate'], function(){
