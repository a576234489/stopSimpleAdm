...
<script type="text/javascript"
	src="${pageContext.request.contextPath }/resources/js/customer/equip/list.js"></script>
	<style>
		#btnBack {
			float:right
		}
...
<div class="page-header">
	...
	<button id="btnEdit" type="button"
		onclick="webside.common.addModel('/equip/addUI.html')"
		class="btn btn-success btn-sm">
		<i class="fa fa-pencil-square-o"></i>&nbsp;添加
	</button>

	<button id="btnEdit" type="button"
		onclick="webside.common.editModel('/equip/editUI.html')"
		class="btn btn-success btn-sm">
		<i class="fa fa-pencil-square-o"></i>&nbsp;编辑
	</button>

	<button id="btnDel" type="button"
		onclick="webside.common.delModel('/equip/delete.html', customSearch)"
...
<div class="input-group">
	<input id="searchKey" type="text" class="input form-control"
		placeholder="装备型号或规格名称..."> <span class="input-group-btn">
	...
	<div class="col-xs-12 widget-container-col ui-sortable"
		...
		<div class="widget-box transparent ui-sortable-handle"
			...
			<div class="widget-header">
				<h4 class="widget-title lighter">装备列表</h4>
