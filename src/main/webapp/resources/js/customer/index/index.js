            ...
            if (rows.length >= 1) {
                ...
                layer.confirm('确认删除吗？', {
                    ...
                    var delete_ids = [];
                     ...
                     $.each(rows, function(index, value) {delete_ids.push(this.id);});
                    
                   /* delete_ids.push(rows[0].id);*/  //只提交第一个id
                    $.ajax({
                        type : "POST",
        ...
        userInfo : {
            ...
            validateUserInfoForm : function() {
                ...
                $('#userInfoForm').validate({
                    ...
                    submitHandler : function(form) {
                        webside.common.commit('userInfoForm', '/user/info.html', '/user/infoUI.html?id=' + $("#userInfoId").val());
                    }
                });
            }
        },
